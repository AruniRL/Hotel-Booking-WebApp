  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <button type='submit' className='bg-blue-600 hover:bg-primary-dull active:scale-95 transition-all text-white
        ...
        <div className='flex flex-col items-start gap-4'> 
            <div className='flex gap-4'>
              <img src={ownerImg} alt='Host' className='h-14 w-14
            ...
            hover:bg-blue-600-dull transition-all cursor-pointer'>
                Contact Now
            </button>
        </div>
    </div>
