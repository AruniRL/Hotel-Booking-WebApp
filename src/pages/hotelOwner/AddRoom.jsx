...
const AddRoom = () => {
  ...
  return (
    <form>
        ...
        enhance the user booking experince.'/>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
            ...
            <div className='mt-4 text-gray-800'>
                ...
                <input type='number' placeholder='0' className='border brder-gray-300 mt-1 rounded p-2 w-24'
        ...
        <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
          {Object.keys(inputs.amenities).map((amenity, index)=>(
            ...
            {inputs.amenities[amenity]} onChange={()=>setInputs({...inputs, amenities: {...inputs.amenities, [amenity]: !inputs.amenities
                [amenity]
            }})}/>
